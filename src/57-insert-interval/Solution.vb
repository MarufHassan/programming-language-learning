	...
	Public Sub Main()
		...
		While True 
			...
			If IsNothing(line) Then
				Exit While
			End If
			DIm intervals = StringToInt2dArray(line)
			Dim newInterval = StringToIntegerArray(inputfile.ReadLine())


			Dim expected = outputfile.ReadLine()
			Dim result = solution.Insert(intervals, newInterval)
			Dim output = Int2dArrayToString(result)
